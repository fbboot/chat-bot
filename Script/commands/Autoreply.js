...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "ami Yeasin": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌ Jarvis 💖",
    ...
    "ki koro": "আমি কিছু করি না তুমি 🫠",
    "hlw": "ki somossa apner 😒",
    "abir": "amar jamai k kano daken?. apner khobor ache 😒",
    "pakhi": "vlo apu kamon achen 🥰",
    "boss": "amar boss - 愛ʟᴜғғʏシ︎ 🤩 "
  };
